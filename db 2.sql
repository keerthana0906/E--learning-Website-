...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2020 at 07:50 PM
...
('Anjali', 'coe20b033@iiitdm.ac.in', 'DBMS', 'what is the difference between primary key , key and candidate key'),
('sindhu', 'sindhu@gmail.com', 'Web Development', 'more information on sessions can be uploaded'),
('Ashwin', 'ashwinshekar@gmail.com', 'linear algebra', 'Is set of rational numbers a vector space?');
...
(1010, 'admin', 'admin', 1),
(1013, 'Harsha', 'harsha123', 0),
(1014, 'Anjali', 'anju12', 0),
(1015, 'Shalini', 'shalu', 0),
(1016, 'subash', 'subs', 0),
(1017, 'Sindhu', 'Sindhu01', 0),
(1018, 'Vikas', 'vicky', 0),
(1019, 'Ashwin', 'shekar', 0);
...
INSERT INTO `map` (`id`, `courseid`, `personid`, `rating`) VALUES
(1, 1, 1013, 3),
(2, 6, 1013, 4),
(3, 5, 1014, 5),
(4, 8, 1014, 3),
...
(1013, 'Harsha', 'harsha@gmail.com', 'IIITDM'),
(1014, 'Anjali', 'coe20b033@iiitdm.ac.in', 'IIIT Kancheepuram'),
(1015, 'Shalini', 'shalini@gmail.com', 'IIITD&M'),
(1016, 'subash', 'subashm@gmail.com', 'IIITDM'),
(1017, 'Sindhu', 'sindhu@gmail.com', 'IIITDM'),
(1018, 'Vikas', 'vikas@gmail.com', 'IIITD&M'),
(1019, 'Ashwin', 'ashwinshekar@gmail.com', 'IIITDM');
...
--
ALTER TABLE `login`
  MODIFY `personid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1020;
COMMIT;
